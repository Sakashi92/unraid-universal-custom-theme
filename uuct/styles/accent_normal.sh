...
##################################
######################################################################
backup_files_location=/boot/extra/uuct/backup/Original_Theme_Files
if [ -d "$backup_files_location" ]; then
	echo
else 
	mkdir /boot/extra/uuct/backup/Original_Theme_Files
fi
######################################################################
backup_files_location_webGui=/boot/extra/uuct/backup/Original_Theme_Files/webGui
if [ -d "$backup_files_location_webGui" ]; then
	echo
else 
	mkdir /boot/extra/uuct/backup/Original_Theme_Files/webGui
fi
######################################################################
...
backup_files_location2=/boot/extra/uuct/backup/Original_Theme_Files/CA
if [ -d "$backup_files_location2" ]; then
	echo 
else 
	mkdir /boot/extra/uuct/backup/Original_Theme_Files/CA
fi
...
if [ $Custom_Icon = 'Y' ] || [ $Custom_Icon = 'y' ]; then
	...
	cp /boot/extra/uuct/backup/Original_Theme_Files/power.png /usr/local/emhttp/plugins/dynamix.system.buttons/icons/power.png
fi
######################################################################
